...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('MinBias_TuneZ2_DsPhiTo2MuPhi_2Mu_cff_py_GEN_FASTSIM_HLT_PU.root'),
...
process.twoMuonFilter = cms.EDFilter("CandViewCountFilter",
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.DsFilter+process.phifromDfilter+process.mufromphifilter+process.genParticlesForFilter+process.muonParticlesInAcc+process.twoMuonFilter)
