...
# with command line options: MyAnalysis/Tau3Mu/MinBias_TuneZ2_DsTau3Mu_cff.py -s GEN,FASTSIM,HLT:7E33v2 --geometry DB --datatier GEN-SIM-DIGI-RECO --conditions START52_V9::All -n 10000 --eventcontent AODSIM --beamspot Realistic8TeVCollision --pileup=2012_Startup_inTimeOnly --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('MinBias_TuneZ2_DsTau3Mu_cff.py nevts:1')
)
